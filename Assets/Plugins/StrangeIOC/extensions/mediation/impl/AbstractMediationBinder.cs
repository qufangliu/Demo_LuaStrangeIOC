...
namespace strange.extensions.mediation.impl
{
	abstract public class AbstractMediationBinder : Binder, IMediationBinder
	{
		...
		public void Trigger(MediationEvent evt, object view)
		{
		...
		protected virtual void ApplyMediationToView(IMediationBinding binding, object view, Type mediatorType)
		{
		...
		protected virtual void InjectViewAndChildren(object view)
		{
		...
		public abstract T GetMediator<T> (object view);
		...
		virtual protected void MapView(object view, IMediationBinding binding)
		{
			Type viewType = view.GetType();
		...
		virtual protected void UnmapView(object view, IMediationBinding binding)
		{
			TriggerInBindings(view, binding, DestroyMediator);
		}

		/// Triggers given function in all mediators bound to given view
		virtual protected void TriggerInBindings(object view, IMediationBinding binding, Func<object, Type, object> method)
		{
			Type viewType = view.GetType();
		...
		protected abstract object CreateMediator(object view, Type mediatorType);

		/// Destroy the Mediator on the provided view object based on the mediatorType
		protected abstract IMediator DestroyMediator(object view, Type mediatorType);

		/// Whether or not an instantiated Mediator of this type exists
		protected abstract bool HasMediator(object view, Type mediatorType);
